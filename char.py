...
play_char_names = {
    ...
    "アヤネ(エクスプローラー)": ["アヤネ(エクスプローラー)", "アヤエク", "アヤタン"],
    "クルミ": ["クルミ"],
    ...
    "キョウカ(サマー)": ["キョウカ(サマー)", "水キョウカ", "水キョ", "ミョウカ"],
    "スズナ": ["スズナ", "ヒデサイ"],
    ...
    "ヨリ(クリスマス)": ["ヨリ(クリスマス)", "クリヨリ"],
    "アカリ": ["アカリ"],
    "アカリ(エンジェル)": ["アカリ(エンジェル)", "アカリエル", "天アカリ"],
    "アカリ(クリスマス)": ["アカリ(クリスマス)", "クリアカリ"],
    "イリヤ": ["イリヤ"],
    ...
    "マホ(エクスプローラー)": ["マホ(エクスプローラー)", "エクマホ", "マホエク", "マホーラ"],
    "カスミ": ["カスミ"],
